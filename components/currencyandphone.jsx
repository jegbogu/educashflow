...
export default function CurrencyAndPhone({ userData }) {
  ...
  async function ConfirmationFnc(e) {
    ...
    if (!response.ok) {
      ...
      showCustomAlert(
        "Thank you for the update, please you will have to login again to continue. Thank you",
        async () => {
          await signOut();
          router.push("/login");
        }
        ...
        <form className="space-y-6 bg-white p-6 rounded-lg shadow-lg w-[95%] max-w-2xl mx-auto my-10 max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-700">
              Just type your country code without + eg: 234
            </p>
          ...
          <div className="flex justify-center">
            <button
              ...
              className="w-full bg-secondary text-white border-2 border-gray-200 p-2 rounded-md sm:w-1/2 mt-5 hover:bg-white hover:text-secondary hover:border-secondary transition"
            >
