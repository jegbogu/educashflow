...
<div className="relative inline-flex items-center">
  ...
  />
  <span className="absolute -top-[-5px] -right-[-2px] bg-red-500 text-white text-xs 
    ...
    3
        ...
        {/* Profile Avatar */}
        <div className="w-10 h-10 flex items-center justify-center border-2 rounded-full bg-gray-200 cursor-pointer"  onClick={openProfileSettings}>
          <img
    ...
    <div>
        <span className="text-[1.5em] font-bold mt-5">{`Welcome back, ${userData.username}!`}</span>
        <p className="text-gray-500">Ready to earn more points today? Let's dive into some exciting quizzes</p>
      </div>
    </div>
  );
}
